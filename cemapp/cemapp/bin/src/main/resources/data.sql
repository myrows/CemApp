...
INSERT INTO COLEGIO(ID,NOMBRE) VALUES (0, 'Sin colegio');

INSERT INTO APP_USER(ID,EMAIL,PASSWORD,COLEGIO_ID) VALUES (NEXTVAL('hibernate_sequence'),'admin@admin.com','admin', 0);
INSERT INTO APP_USER_ROLES(APP_USER_ID, ROLES) VALUES (1, 'SUPERADMIN');

/*2*/
INSERT INTO COLEGIO(ID,NOMBRE) VALUES (NEXTVAL('hibernate_sequence'),'Salesianos San Pedro');
/*3*/
INSERT INTO COLEGIO(ID,NOMBRE) VALUES (NEXTVAL('hibernate_sequence'),'Salesianos Trinidad');
/*4*/
INSERT INTO COLEGIO(ID,NOMBRE) VALUES (NEXTVAL('hibernate_sequence'),'Salesianos Linares');
/*5*/
INSERT INTO COLEGIO(ID,NOMBRE) VALUES (NEXTVAL('hibernate_sequence'),'Salesianos Ubeda');


/*6*/
INSERT INTO ANYO_ESCOLAR(ID,FECHA_ANYO_ESCOLAR,NOMBRE_ANYO_ESCOLAR) VALUES (NEXTVAL('hibernate_sequence'),'2018-09-01','2018-2019');
/*7*/
INSERT INTO ANYO_ESCOLAR(ID,FECHA_ANYO_ESCOLAR,NOMBRE_ANYO_ESCOLAR) VALUES (NEXTVAL('hibernate_sequence'),'2017-09-01','2017-2018');
/*8*/
INSERT INTO ANYO_ESCOLAR(ID,FECHA_ANYO_ESCOLAR,NOMBRE_ANYO_ESCOLAR) VALUES (NEXTVAL('hibernate_sequence'),'2016-09-01','2016-2017');
/*9*/
INSERT INTO ANYO_ESCOLAR(ID,FECHA_ANYO_ESCOLAR,NOMBRE_ANYO_ESCOLAR) VALUES (NEXTVAL('hibernate_sequence'),'2015-09-01','2015-2016');



INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (6,2);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (6,3);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (6,4);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (6,5);

INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (7,2);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (7,3);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (7,4);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (7,5);

INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (8,2);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (8,3);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (8,4);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (8,5);

INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (9,2);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (9,3);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (9,4);
INSERT INTO ANYO_ESCOLAR_LISTA_COLEGIOS (ANYO_ESCOLAR_ID,COLEGIO_ID) VALUES (9,5);


/*10*/
INSERT INTO ETAPA (ID,NOMBRE,PESO,ANYO_ESCOLAR_ID) VALUES(NEXTVAL('hibernate_sequence'),'Formacion Profesional',10,6);
/*11*/
INSERT INTO ETAPA (ID,NOMBRE,PESO,ANYO_ESCOLAR_ID,PADRE_ID) VALUES(NEXTVAL('hibernate_sequence'),'Formacion Profesional Basica',11,6,10);
/*12*/
INSERT INTO ETAPA (ID,NOMBRE,PESO,ANYO_ESCOLAR_ID,PADRE_ID) VALUES(NEXTVAL('hibernate_sequence'),'Formacion Profesional Grado Medio',12,6,10);
/*13*/
INSERT INTO ETAPA (ID,NOMBRE,PESO,ANYO_ESCOLAR_ID,PADRE_ID) VALUES(NEXTVAL('hibernate_sequence'),'Formacion Profesional Grado Superior',13,6,10);



/*14*/
INSERT INTO CURSO (ID,NOMBRE,PESO,ETAPA_ID) VALUES (NEXTVAL('hibernate_sequence'),'1º DAM',14,13);
/*15*/
INSERT INTO CURSO (ID,NOMBRE,PESO,ETAPA_ID) VALUES (NEXTVAL('hibernate_sequence'),'2º DAM',15,13);
/*16*/
INSERT INTO CURSO (ID,NOMBRE,PESO,ETAPA_ID) VALUES (NEXTVAL('hibernate_sequence'),'1º TELECO',16,12);
/*17*/
INSERT INTO CURSO (ID,NOMBRE,PESO,ETAPA_ID) VALUES (NEXTVAL('hibernate_sequence'),'2º TELECO',17,12);
/*18*/
INSERT INTO CURSO (ID,NOMBRE,PESO,ETAPA_ID) VALUES (NEXTVAL('hibernate_sequence'),'1º ELECTRICIDAD Y ELECTRONICA',18,11);
/*19*/
INSERT INTO CURSO (ID,NOMBRE,PESO,ETAPA_ID) VALUES (NEXTVAL('hibernate_sequence'),'2º ELECTRICIDAD Y ELECTRONICA',19,11);




/*20*/
INSERT INTO UNIDAD (ID,NOMBRE,PESO,CURSO_ID) VALUES (NEXTVAL('hibernate_sequence'),'A',20,14);
/*21*/
INSERT INTO UNIDAD (ID,NOMBRE,PESO,CURSO_ID) VALUES (NEXTVAL('hibernate_sequence'),'A',21,15);
/*22*/
INSERT INTO UNIDAD (ID,NOMBRE,PESO,CURSO_ID) VALUES (NEXTVAL('hibernate_sequence'),'A',22,16);
/*23*/
INSERT INTO UNIDAD (ID,NOMBRE,PESO,CURSO_ID) VALUES (NEXTVAL('hibernate_sequence'),'A',23,17);
/*24*/
INSERT INTO UNIDAD (ID,NOMBRE,PESO,CURSO_ID) VALUES (NEXTVAL('hibernate_sequence'),'A',24,18);
/*25*/
INSERT INTO UNIDAD (ID,NOMBRE,PESO,CURSO_ID) VALUES (NEXTVAL('hibernate_sequence'),'A',25,19);